...
augroup encrypted
  ...
  autocmd BufReadPost,FileReadPost *.enc execute "1,$!/usr/bin/openssl aes-256-cbc -d -md md5 -iter 10 -k '" . b:secret . "'"
  ...
  autocmd BufWritePre,FileWritePre *.enc execute "1,$!/usr/bin/openssl aes-256-cbc -md md5 -iter 10 -k '" . b:secret . "'"
